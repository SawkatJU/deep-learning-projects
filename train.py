...
def main():
    train_ds = DRDataset(
        images_folder="/content/images650/images_650_650",
        path_to_csv="/content/trainLabels.csv",
        transform=config.val_transforms,
    )
    val_ds = DRDataset(
        images_folder="/content/images650/images_650_650",
        path_to_csv="/content/valLabels.csv",
        transform=config.val_transforms,
    )
    test_ds = DRDataset(
        images_folder="/content/images650/images_650_650",
    ...
    get_csv_for_blend(val_loader, model, "/content/val_blend.csv")
    get_csv_for_blend(train_loader, model, "/content/train_blend.csv")
    get_csv_for_blend(test_loader, model, "/content/test_blend.csv")
